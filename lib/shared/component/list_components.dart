...
import '../../modules/premScreens/home_page.dart';
import '../../modules/premScreens/teamsNews/LatestScreens/AllnewsScreen.dart';



Widget buildArticleItem(Map newsList,context)=>
 GestureDetector(
   onTap: (){
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      image: DecorationImage(
                        image: AssetImage('${newsList['image']}'),
                        fit: BoxFit.cover,
...
Widget matchstime(MatchTimeModel model3,context)=>
  Container(
    decoration:BoxDecoration(
...
Widget matchsResult(MatchesResultsModel matchesResault,context)=>
  Container(
    width: 370,
    decoration: BoxDecoration(
      gradient: LinearGradient(
    ...
    // Row(
           ...
           Container(
             ...
             child: Padding(
             padding: const EdgeInsets.only(left:4.0,right: 4,top: 6,bottom: 0),
             child: Column(
               //mainAxisAlignment: MainAxisAlignment.center,
                   ...
                   Column(
                     children: [
                       Container(
                         width: 150,
                         child: Center(
                           child: Text('${matchesResault.homeName}',
                             maxLines: 1,
                                 style:TextStyle(
                                   fontSize: 25,
                      ...
                      Column(
                        children: [
                          Container(
                            width: 150,
                            child: Center(
                              child: Text('${matchesResault.awayName}',
                        maxLines: 1,
                        //overflow:TextOverflow.ellipsis ,
                                 style: TextStyle(
                                   fontSize: 25,
...
Widget buildVideosItem(Map VideoList,context,int index)=>
     Padding(
...
Widget ScorersBuildItem(ScorersModel model,context,int? index)=>
    Padding(
      padding: const EdgeInsets.all(5.0),
      child: Container(
  height: 35,
  ...
  child: Padding(
    ...
    child: Row(
      children: [
        ...
        Container(
          width: 75,
          child: Text('${model2.statistics?[0].team?.name} ',
            style: TextStyle(
              color: Colors.grey,
            ),),
        ),
        ...
        Container(
          width: 30,
          child: Text('${model2.statistics?[0].goals?.assists} ',
            style: TextStyle(
              color: Colors.grey,
              fontWeight: FontWeight.bold
            ),),
  ...
  child: Padding(
    ...
    child: Row(
      children: [
        ...
        Container(
          width: 30,
          child: Text('${model4.statistics?[0].cards?.yellow} ',
            style: TextStyle(
              color: Colors.black,
            ),),
        ),
        ...
        Container(
          width: 20,
          child: Text('${model4.statistics?[0].cards?.red} ',
            style: TextStyle(
              color: Colors.black,
            ),),
        ),
